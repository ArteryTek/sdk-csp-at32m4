 ...
 * Change Logs:
 * Date           Author       Notes
 * 2024-09-09     shelton      first version
 */
...
#define UART_IS_RX        (0U)
    ...
    static const struct gpio_uart_mux uart_muxs[] =
    {
        ...
        { .pin_index = GET_PIN(F, 0),  .uart_num = UART_IS_RX|1, .mux_num = 7 },
        { .pin_index = GET_PIN(F, 1),  .uart_num = UART_IS_TX|1, .mux_num = 7 },

        /* usart2 configure */
        { .pin_index = GET_PIN(A, 0),  .uart_num = UART_IS_RX|2, .mux_num = 8 },
        ...
        { .pin_index = GET_PIN(A, 11), .uart_num = UART_IS_TX|2, .mux_num = 8 },
        { .pin_index = GET_PIN(A, 12), .uart_num = UART_IS_RX|2, .mux_num = 8 },
        { .pin_index = GET_PIN(A, 14), .uart_num = UART_IS_TX|2, .mux_num = 8 },
        { .pin_index = GET_PIN(A, 15), .uart_num = UART_IS_RX|2, .mux_num = 8 },
        { .pin_index = GET_PIN(B, 0),  .uart_num = UART_IS_RX|2, .mux_num = 7 },
        { .pin_index = GET_PIN(B, 3),  .uart_num = UART_IS_TX|2, .mux_num = 8 },
        { .pin_index = GET_PIN(B, 4),  .uart_num = UART_IS_RX|2, .mux_num = 8 },
    };
    /* get tx/rx pin index */
